...
/// <summary>
/// Checks GitHub releases for newer Sentry Deck versions.
/// </summary>
public sealed class UpdateService
{
    public const string ReleasesApiUrl = "https://api.github.com/repos/danielchalmers/SentryDeck/releases";
    public const string ReleasesPageUrl = "https://github.com/danielchalmers/SentryDeck/releases";
    ...
    private static HttpClient CreateHttpClient()
    {
        ...
        client.DefaultRequestHeaders.UserAgent.ParseAdd("SentryDeck");
